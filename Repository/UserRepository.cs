...
namespace Raamen.Repository
{
    public class UserRepository
    {
        ...
        public void updateUser(int id,string Username, string Email, string gender, string password)
        {
        ...
        {
            User u = (from user in db.Users where user.Id == id select user).FirstOrDefault();
            return u;
        }
    }
}